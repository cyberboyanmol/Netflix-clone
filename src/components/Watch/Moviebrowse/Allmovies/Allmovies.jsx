...
const Allmovies = (props) => {
  ...
  useEffect(()=> {  
      ...
      axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=b01f7a54e2ff090e41ca2c91f05e7159&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}&with_watch_monetization_types=flatrate`)
      .then((resp)=> {
